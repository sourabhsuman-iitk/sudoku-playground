...
let solvedmsg = document.querySelector(".solved-message")
function initActions() {
    ...
    function submitHandler(event) {
        ...
        if (isValid) {
            let cmsg = document.querySelector('.congo-message')
            cmsg.style.display="block";
            setTimeout(function(){ cmsg.style.display="none" }, 2000);
            // alert("You've Solved this. Awesome!!!")
        } else {
            let wmsg = document.querySelector('.wrong-message')
            wmsg.style.display="block";
            setTimeout(function(){ wmsg.style.display="none" }, 2000);
